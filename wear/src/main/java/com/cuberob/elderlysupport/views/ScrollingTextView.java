package com.cuberob.elderlysupport.views;
...
public class ScrollingTextView extends TextView implements Runnable {
    ...
    private boolean alwaysScroll = false;
    ...
    private void scroll() {
        if(!alwaysScroll && textFitsWithoutScrolling()){
            return;
        }
    ...
    private boolean textFitsWithoutScrolling() {
    ...
    public void setAlwaysScroll(boolean alwaysScroll) {
        this.alwaysScroll = alwaysScroll;
    }
}
